...
public class TournamentForm extends ContentPanel {
    ...
    public TournamentForm() {
        ...
        fieldList = ObservableCollections.observableList(new ArrayList<String>());
     ...
     *
     * @param fieldList new value of fieldList
     */
     ...
     *
     * @param selectedFields new value of selectedFields
     */
    ...
    private boolean validateForm() {
        ...
        if (expireDatePicker.getDate().before(today)) {
            messagePanel.addMessage("Abmeldungsablaufdatum liegt in der Vergangenheit.");
            valid = false;
        } else if (startDatePicker.getDate().before(expireDatePicker.getDate())) {
            messagePanel.addMessage("Startdatum liegt vor dem Abmeldungsablaufdatum.");
            valid = false;
        }
    ...
    public void createTournament() {
        Tournament t = new Tournament(txtLabel.getText(), (Float) spnFee.getValue(), (Integer) spnMaxPart.getValue(), txtPartCond.getText(), (Integer) spnStdGameDuration.getValue(), startDatePicker.getDate());
     ...
     *
     * @param b Turniererstellmodus aktiviert werden
     */
    public void setTournamentCreateEnabled(boolean b) {
        ...
        firePropertyChange("tournamentCreateEnabled", old, isTournamentCreateEnabled());
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(control.MainApplication.class).getContext().getResourceMap(TournamentForm.class);
        ...
        panelTournament.setBorder(javax.swing.BorderFactory.createTitledBorder(resourceMap.getString("panelTournament.border.title"))); // NOI18N
        ...
        cmbType.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Einzelspieler-Turnier", "Mehrspieler-Turnier" }));
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(control.MainApplication.class).getContext().getActionMap(TournamentForm.class, this);
        cmbType.setAction(actionMap.get("chooseTournamentTypeAction")); // NOI18N
        cmbType.setName("cmbType"); // NOI18N

        javax.swing.GroupLayout panelTournamentLayout = new javax.swing.GroupLayout(panelTournament);
        panelTournament.setLayout(panelTournamentLayout);
        panelTournamentLayout.setHorizontalGroup(
            panelTournamentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelTournamentLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelTournamentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lblType)
                    .addComponent(lblLabel))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelTournamentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(cmbType, 0, 183, Short.MAX_VALUE)
                    .addComponent(txtLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 183, Short.MAX_VALUE))
                .addContainerGap())
        );
        panelTournamentLayout.setVerticalGroup(
            panelTournamentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelTournamentLayout.createSequentialGroup()
                .addGroup(panelTournamentLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        panelObligatory.setBorder(javax.swing.BorderFactory.createTitledBorder(resourceMap.getString("panelObligatory.border.title"))); // NOI18N
        ...
        lblMaxPlayerProTeam.setText(resourceMap.getString("lblMaxPlayerProTeam.text")); // NOI18N
        ...
        lblMatchDuration.setText(resourceMap.getString("lblMatchDuration.text")); // NOI18N
        ...
        expireDatePicker.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
        ...
        spnMaxPart.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(1), Integer.valueOf(1), null, Integer.valueOf(1)));
        spnMaxPart.setName("spnMaxPart"); // NOI18N

        spnMaxPlayers.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(1), Integer.valueOf(1), null, Integer.valueOf(1)));
        spnMaxPlayers.setEnabled(false);
        spnMaxPlayers.setName("spnMaxPlayers"); // NOI18N

        spnFee.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(0.0f), Float.valueOf(0.0f), null, Float.valueOf(1.0f)));
        spnFee.setName("spnFee"); // NOI18N

        spnLateRegFee.setModel(new javax.swing.SpinnerNumberModel(Float.valueOf(0.0f), Float.valueOf(0.0f), null, Float.valueOf(1.0f)));
        spnLateRegFee.setName("spnLateRegFee"); // NOI18N

        spnStdGameDuration.setModel(new javax.swing.SpinnerNumberModel(Integer.valueOf(1), Integer.valueOf(1), null, Integer.valueOf(10)));
        spnStdGameDuration.setName("spnStdGameDuration"); // NOI18N

        javax.swing.GroupLayout panelObligatoryLayout = new javax.swing.GroupLayout(panelObligatory);
        panelObligatory.setLayout(panelObligatoryLayout);
        panelObligatoryLayout.setHorizontalGroup(
            panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelObligatoryLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelObligatoryLayout.createSequentialGroup()
                        .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lblStartDate)
                            .addComponent(lblLateRegFee)
                            .addComponent(lblSportKind)
                            .addComponent(lblFee)
                            .addComponent(lblMaxPlayerProTeam, javax.swing.GroupLayout.PREFERRED_SIZE, 220, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(lblMaxPart)
                            .addComponent(lblExpireDate)
                            .addComponent(lblLocation))
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtSportKind, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                            .addComponent(spnMaxPart, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                            .addComponent(spnMaxPlayers, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                            .addComponent(spnFee, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                            .addComponent(spnLateRegFee, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                            .addComponent(spnStdGameDuration, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                            .addComponent(startDatePicker, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                            .addComponent(expireDatePicker, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)
                            .addComponent(txtLocation, javax.swing.GroupLayout.DEFAULT_SIZE, 193, Short.MAX_VALUE)))
                    .addComponent(lblMatchDuration))
                .addContainerGap())
        );
        panelObligatoryLayout.setVerticalGroup(
            panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelObligatoryLayout.createSequentialGroup()
                .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblSportKind, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(txtSportKind, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(5, 5, 5)
                .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(spnMaxPart, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lblMaxPart))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(lblMaxPlayerProTeam)
                    .addComponent(spnMaxPlayers, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblFee)
                    .addComponent(spnFee, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblLateRegFee)
                    .addComponent(spnLateRegFee, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelObligatoryLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblMatchDuration)
                    .addComponent(spnStdGameDuration, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
        );

        panelPartCond.setBorder(javax.swing.BorderFactory.createTitledBorder(resourceMap.getString("panelPartCond.border.title"))); // NOI18N
        ...
        javax.swing.GroupLayout panelPartCondLayout = new javax.swing.GroupLayout(panelPartCond);
        panelPartCond.setLayout(panelPartCondLayout);
        panelPartCondLayout.setHorizontalGroup(
            panelPartCondLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelPartCondLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(jScrollPane1, javax.swing.GroupLayout.DEFAULT_SIZE, 706, Short.MAX_VALUE)
                .addContainerGap())
        );
        panelPartCondLayout.setVerticalGroup(
            panelPartCondLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(panelPartCondLayout.createSequentialGroup()
        ...
        panelFields.setBorder(javax.swing.BorderFactory.createTitledBorder(resourceMap.getString("panelFields.border.title"))); // NOI18N
        panelFields.setName("panelFields"); // NOI18N

        txtFieldName.setName("txtFieldName"); // NOI18N
        txtFieldName.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
        ...
        org.jdesktop.beansbinding.ELProperty eLProperty = org.jdesktop.beansbinding.ELProperty.create("${fieldList}");
        org.jdesktop.swingbinding.JListBinding jListBinding = org.jdesktop.swingbinding.SwingBindings.createJListBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, eLProperty, fieldListView);
        bindingGroup.addBinding(jListBinding);
        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, this, org.jdesktop.beansbinding.ELProperty.create("${selectedFields}"), fieldListView, org.jdesktop.beansbinding.BeanProperty.create("selectedElements"));
        bindingGroup.addBinding(binding);

        fieldListView.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
        ...
        panelFieldsLayout.setHorizontalGroup(
            ...
            .addGroup(panelFieldsLayout.createSequentialGroup()
                ...
                .addGroup(panelFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(fieldsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 251, Short.MAX_VALUE)
                    .addGroup(panelFieldsLayout.createSequentialGroup()
                        .addComponent(lblFieldName)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtFieldName, javax.swing.GroupLayout.DEFAULT_SIZE, 104, Short.MAX_VALUE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
        ...
        panelFieldsLayout.setVerticalGroup(
            ...
            .addGroup(panelFieldsLayout.createSequentialGroup()
                .addGroup(panelFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnAddField))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(fieldsScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 99, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(panelFieldsLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btnRemoveField)
                    .addComponent(jButton1)))
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(messagePanel, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 738, Short.MAX_VALUE)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(panelPartCond, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(panelTournament, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            .addComponent(panelObligatory, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addComponent(panelObligatory, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(panelPartCond, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void fieldListViewValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_fieldListViewValueChanged
    ...
    public void setAddFieldActionEnabled(boolean b) {
        ...
        firePropertyChange("addFieldActionEnabled", old, isAddFieldActionEnabled());
    }
    ...
    public void genFieldNamesAction() {
        String input = JOptionPane.showInputDialog(
            MainApplication.getApplication().getMainView().getFrame(),
